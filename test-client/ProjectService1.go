...
type ApplyNewClientToProjectError1 struct {
	AreExpensesAlreadyEnteredAgainstProject *bool              `xml:"http://replicon.com/ areExpensesAlreadyEnteredAgainstProject"`
	CurrentClient                           *ClientReference1  `xml:"http://replicon.com/ currentClient"`
	IsNewClientInactive                     *bool              `xml:"http://replicon.com/ isNewClientInactive"`
	IsTimeAlreadyEnteredAgainstProject      *bool              `xml:"http://replicon.com/ isTimeAlreadyEnteredAgainstProject"`
...
type CustomFieldValueDetails1 struct {
	...
	Number          *float64                   `xml:"http://replicon.com/ number"`
...
type MoneyDetails1 struct {
	Amount   *big.Rat            `xml:"http://replicon.com/ amount"`
...
type ProjectBillableSeriesDataPoint1 struct {
	BillableAmountActual    *big.Rat        `xml:"http://replicon.com/ billableAmountActual"`
	BillableAmountDelta     *big.Rat        `xml:"http://replicon.com/ billableAmountDelta"`
	BillableAmountEstimated *big.Rat        `xml:"http://replicon.com/ billableAmountEstimated"`
...
type ProjectBillingRateDetails1 struct {
	...
	IsAvailableForAssignmentToTeamMembers *bool                    `xml:"http://replicon.com/ isAvailableForAssignmentToTeamMembers"`
}
...
type ProjectCodeSettingsDetails1 struct {
	NextProjectCode          *uint32 `xml:"http://replicon.com/ nextProjectCode"`
...
type ProjectCostSeriesDataPoint1 struct {
	CostAmountActual    *big.Rat        `xml:"http://replicon.com/ costAmountActual"`
	CostAmountDelta     *big.Rat        `xml:"http://replicon.com/ costAmountDelta"`
	CostAmountEstimated *big.Rat        `xml:"http://replicon.com/ costAmountEstimated"`
	Period              *PeriodDetails1 `xml:"http://replicon.com/ period"`
}
...
type ProjectDetails1 struct {
	...
	IsProjectLeaderApprovalRequired *bool                              `xml:"http://replicon.com/ isProjectLeaderApprovalRequired"`
	IsTimeEntryAllowed              *bool                              `xml:"http://replicon.com/ isTimeEntryAllowed"`
	Name                            *string                            `xml:"http://replicon.com/ name"`
...
type ProjectExpenseCodeDetails1 struct {
	ExpenseCode                     *ExpenseCodeReference1 `xml:"http://replicon.com/ expenseCode"`
	IsExpenseEntryToThisCodeAllowed *bool                  `xml:"http://replicon.com/ isExpenseEntryToThisCodeAllowed"`
}
...
type ProjectTeamMemberActualsSummary1 struct {
	...
	ActualCostTotal           *MultiCurrencyMoneyDetails1 `xml:"http://replicon.com/ actualCostTotal"`
	ActualHoursTotal          *CalendarDayDuration1       `xml:"http://replicon.com/ actualHoursTotal"`
	IsActiveProjectTeamMember *bool                       `xml:"http://replicon.com/ isActiveProjectTeamMember"`
	Resource                  *ResourceReference1         `xml:"http://replicon.com/ resource"`
}
...
type TaskParameter1 struct {
	...
	EstimatedCost      *MoneyParameter2                   `xml:"http://replicon.com/ estimatedCost"`
	EstimatedHours     *TaskDuration1                     `xml:"http://replicon.com/ estimatedHours"`
	IsClosed           *bool                              `xml:"http://replicon.com/ isClosed"`
	IsTimeEntryAllowed *bool                              `xml:"http://replicon.com/ isTimeEntryAllowed"`
	Name               *string                            `xml:"http://replicon.com/ name"`
	PercentCompleted   *int32                             `xml:"http://replicon.com/ percentCompleted"`
	Target             *TaskTargetParameter1              `xml:"http://replicon.com/ target"`
...
type UpdateAllowTimeEntryAgainstTasksOnly struct {
	...
	ProjectUri                     *string  `xml:"http://replicon.com/ projectUri"`
	AllowTimeEntryAgainstTasksOnly *bool    `xml:"http://replicon.com/ allowTimeEntryAgainstTasksOnly"`
}
...
type UpdateExpenseCodeAllowingExpenseEntry struct {
	...
	Allowed        *bool    `xml:"http://replicon.com/ allowed"`
}
...
type UpdateProjectCodeSettingForNewProjectsAsAutoincrementingNumber struct {
	...
	StartingProjectCode *uint32  `xml:"http://replicon.com/ startingProjectCode"`
}
...
type UpdateProjectLeaderApprovalIsRequired struct {
	...
	ProjectUri *string  `xml:"http://replicon.com/ projectUri"`
	IsRequired *bool    `xml:"http://replicon.com/ isRequired"`
}
